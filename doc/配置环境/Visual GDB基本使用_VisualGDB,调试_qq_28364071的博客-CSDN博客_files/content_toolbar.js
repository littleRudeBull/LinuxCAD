...
(function() {
    ...
    s.type = 'text/javascript';
    s.async = true;
    s.src = 'https://g.csdnimg.cn/asdf/1.0.8/trackad.js';
    var x = document.getElementsByTagName('script')[0];
    x.parentNode.insertBefore(s, x);
})();
    ...
    var tpl = '\<div id="csdn-toolbar" class="csdn-toolbar tb_disnone ' + skin + fixed + '">\
        <div class="container row center-block " id="csdn_container_tool">\
          ...
          <div class="pull-right onlyUser searchUser login-wrap '+ loginMark + '">\
            <ul class="btns">\
              <li class="write-bolg-btn" data-report-click=\'{"mod":"popu_370","dest":"https://mpnew.csdn.net/console/editor/html"}\' data-report-view=\'{"mod":"popu_370","dest":"https://mpnew.csdn.net/console/editor/html"}\'><a class="" href="//mpnew.csdn.net/console/editor/html" target="_blank" id="blogClick">\
              ...
              <li class="userLogin">\
                ...
                <div data-report-click=\'{"mod":"popu_789","dest":"https://i.csdn.net/#/account/index","extend1":"帐号设置"}\'><i class="pull_icon pull_icon7"></i><a href="https://i.csdn.net/#/account/index" target="_blank">帐号设置</a></div>\
                  ...
                  <div data-report-click=\'{"mod":"popu_789","dest":"https://mpnew.csdn.net","extend1":"管理博客"}\'><i class="pull_icon pull_icon6"></i><a href="https://mpnew.csdn.net" target="_blank">管理博客</a></div>\
